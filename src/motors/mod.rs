...
const QUERY_IDSHARE_R: [u8; 17] = [ 0x01, 0x10, 0x09, 0x80, 0x00, 0x06, 0x0C, 0x00, 0x00, 0x00, 0x0F, 0x00, 0x00, 0x00, 0x02, 0x00, 0x00, ];
const QUERY_IDSHARE_L: [u8; 17] = [ 0x02, 0x10, 0x09, 0x80, 0x00, 0x06, 0x0C, 0x00, 0x00, 0x00, 0x0F, 0x00, 0x00, 0x00, 0x02, 0x00, 0x00, ];
...
fn send_command(port: &mut Box<dyn SerialPort>, command_with_crc_space: &mut [u8]) -> Result<(), String> {
    ...
    println!("[Motor Thread] Sending command: {:02X?}", command_with_crc_space);
